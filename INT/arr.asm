;Write an 8086 assembly program to find the sum of elements in an array using:

;1. Indirect addressing (using registers like SI or DI)
;2. Indexed addressing (using array[SI])
;3. Based indexed addressing (using BX+SI)
.MODEL small
.STACK 100h
